...
class Task(models.Model):
    ...
    task_type = fields.IntEnumField(enum_type=TaskType, default=TaskType.UI, description="任务类型")
    create_time = fields.DatetimeField(auto_now_add=True, description="创建时间")
    update_time = fields.DatetimeField(auto_now=True, description="更新时间")
    suites = fields.ManyToManyField("models.Suite", related_name="tasks", default=[], description="任务中套件",
